...
var secIncorrectLoginViewComponent = (function () {
    function secIncorrectLoginViewComponent(dataService) {
    ...
    secIncorrectLoginViewComponent.prototype.getProcesses = function (callback) {
        var self = this;
        self.loading = true;
    ...
    secIncorrectLoginViewComponent.prototype.getAvarageNumber = function (callback) {
        var self = this;
        self.loading = true;
...
secIncorrectLoginViewComponent = __decorate([
    core_1.Component({
        ...
        templateUrl: 'sec-incorrect-login.template.html'
    }),
    __metadata("design:paramtypes", [data_service_1.DataService])
], secIncorrectLoginViewComponent);
exports.secIncorrectLoginViewComponent = secIncorrectLoginViewComponent;
//# sourceMappingURL=sec-incorrect-login.component.js.map